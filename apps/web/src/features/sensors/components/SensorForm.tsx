...
import {
    ...
    ModalContent,
    ModalTitle,
    Select, // Mantenemos Select para "Estado" que son solo 2 opciones fijas
    SubmitButton,
    Form,
    Label,
} from "../styled";
...
export default function SensorForm({
    ...
    if (!sensor) {
        throw new Error("Sensor no proporcionado");
    }
        ...
        <Modal onClick={onClose}>
            <ModalContent onClick={(e) => e.stopPropagation()}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    {/* NUEVO — SearchableSelect de máquina */}
                    <FormGroup>
                        <Label>Máquina</Label>
                        <div style={{ width: '100%' }}>
                            <SearchableSelect 
                                options={machineOptions}
                                value={formData.machineId || 0}
                                onChange={(val) => 
                                    setFormData((prev) => ({
                                        ...prev,
                                        machineId: val
